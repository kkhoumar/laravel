        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="{{route('admin.store')}}">
              ...
              <span class="menu-title">Espace Administateur</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
              <i class="ti-clipboard menu-icon"></i>
              <span class="menu-title">creation de produit</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="{{route('ajouterCategorie')}}">categorie</a></li>
                <li class="nav-item"><a class="nav-link" href="{{route('ajouterproduit')}}">produits</a></li>
                <li class="nav-item"><a class="nav-link" href="validation.html">sliders</a></li>
