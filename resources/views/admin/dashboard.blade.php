...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{asset('acken/css/themify-icons.css')}}">
  <link rel="stylesheet" href="{{asset('acken/css/vendor.bundle.base.css')}}">
  <link rel="stylesheet" href="{{asset('acken/css/vendor.bundle.addons.css')}}">
  <!-- endinject -->
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="{{asset('images/logo_2H_tech.png')}}" />
</head>
<body>
